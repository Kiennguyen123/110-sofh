...
function ExaminationOutPatient(props) {
  const { inforKhamBenh } = props;
  return (
    <div className="content-service">
      {inforKhamBenh.map((infor) => {
        const {
          id,
          tenDichVu,
          bacSiKham,
...
export const MemoizedExaminationOutPatient = memo(
  ExaminationOutPatient,
);
export default ExaminationOutPatient;
